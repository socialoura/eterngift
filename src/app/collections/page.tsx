...
import { 
  ...
  ChevronDown, X, CreditCard, Truck, Shield, Gift
} from 'lucide-react'
    ...
    <>
      ...
      >
        <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100">
          ...
          {/* Image */}
          <Link href={`/products/${product.id}`} className="block relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
            <Image
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-gray-900 mb-6">
              Our <span className="bg-gradient-to-r from-[#B71C1C] to-[#D4AF88] bg-clip-text text-transparent">Eternal</span> Gifts
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover our handcrafted collection of eternal roses and personalized jewelry. 
              Each piece is designed to express your love and create lasting memories.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-white text-center">
            {[
              ...
              { icon: Heart, title: 'Made with Love', desc: 'Handcrafted quality' },
            ].map((feature, i) => (
              <motion.div
                key={i}
